function [call_model,func_struct] = define_model_Q4()
...
% Combined function
TotalAbsQ4 = @(Eg,A,wL,wG,Ec,u,w2,E2,w3,E3,w4,E4,h,k,c1,c2,c3,B,bw,beep,x) doped_1s(A,wL,wG,Ec,x) + Hx(A,u,w2,E2,w3,E3,w4,E4,x) + BAND(Eg,h,k,c1,c2,c3,B,bw,beep,x);

% Call functions again to only require vector of parameters and data x
call_model = @(W,x) TotalAbsQ4(W(1),W(2),W(3),W(4),W(5),W(6),W(7),W(8),W(9),W(10),W(11),W(12),W(13),W(14),W(15),W(16),W(17),W(18),W(19),W(20),x);
