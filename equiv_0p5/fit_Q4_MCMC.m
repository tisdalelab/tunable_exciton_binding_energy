...
ub =   [3.05  3   0.12  0.08  2.750  2.0   0.16  2.95  0.12  3.000 0.12   3.000    3.0   30    3.0   3.0   3.0   3.350  0.25    0.35  ];
lb =   [2.94  0.1 0.03  0.015 2.650  0.05  0.03  2.75  0.02  2.75  0.005  2.900    0.1   5     0.1   0.1   0.1   3.100  0.050   0.1  ];
...
A = csvread('Q4_AllT_A.csv');
T = csvread('Q4_AllT_T.csv');
x = csvread('Q4_AllT_x.csv');
...
for i = 1:N_T
    ...
    mkdir(Tspec_str)
    save_file_spec = ['Q4fitvals_linkedHx_',Tspec_str,'K'];
